            ...
            return BlocBuilder<ProfileFormBloc, ProfileFormState>(
              builder: (context, stateForm) {
                ...
                return BlocBuilder<ProfileBloc, ProfileState>(
                  builder: (context, stateBuilderProfile) {
                    return Scaffold(
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                stateBuilderProfile.maybeMap(
                                  orElse: () => Container(),
                                  loadInProgress: (value) => const Center(child: CircularProgressIndicator(),),
                                  loadFailure: (value) => const Text('Failure'),
                                  loadSuccess: (value) {
