...
abstract class $LoginDtoCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? message, String? access_token});
}
...
class _$_LoginDto extends _LoginDto {
  const _$_LoginDto({this.message, this.access_token}) : super._();
  ...
  @override
  String toString() {
    return 'LoginDto(message: $message, access_token: $access_token)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, message, access_token);
...
abstract class _LoginDto extends LoginDto {
  const factory _LoginDto({final String? message, final String? access_token}) =
      _$_LoginDto;
