...
abstract class $LoginCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? message, String? accessToken});
}
...
class _$_Login extends _Login {
  const _$_Login({required this.message, required this.accessToken})
      : super._();
  ...
  @override
  String toString() {
    return 'Login(message: $message, accessToken: $accessToken)';
  }
...
abstract class _Login extends Login {
  const factory _Login(
      ...
      required final String? accessToken}) = _$_Login;
